...
#define STM32_IRQ_TIM6 STM32_IRQ_TIM6_DAC
...
#define STM32_RCC_APB2RSTR_SPI1RST BIT(12)
#define STM32_RCC_APB1RSTR REG32(STM32_RCC_BASE + 0x10)
#define STM32_RCC_APB1RSTR_SPI2RST BIT(29)
...
#define STM32_RCC_APB1ENR_SPI2EN BIT(29)
