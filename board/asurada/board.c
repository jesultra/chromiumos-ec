...
const struct adc_t adc_channels[] = {
	...
	{"TEMP_SENSOR_SUBPMIC", ADC_MAX_MVOLT, ADC_READ_MAX+1, 0, CHIP_ADC_CH0},
	...
	{"TEMP_SENSOR_CHARGER", ADC_MAX_MVOLT, ADC_READ_MAX+1, 0, CHIP_ADC_CH5},
...
struct bc12_config bc12_ports[2] = {
	{ .drv = &mt6360_drv },
	{ .drv = &pi3usb9201_drv },
};
