 ...
 * blocked in any dap_xxx() methods in gpio.c or i2c.c, they will be unwound
 * before the hook in these files are executed to reset their state, and such
 * that CMSIS-DAP restores JTAG pins to pre-connection state BEFORE gpio.c
