...
{
	STM32_GPIO_OSPEEDR(STM32_GPIOA_BASE) = 0;
}
			 ...
			 struct usart_config const *usart)
{
	...
	// TODO: usart_set_parity(usart, 0);
	// TODO: usart_set_baud(usart, 115200);
	// TODO: usart_set_break(usart, false);
}
...
const char *board_read_serial(void)
{
	...
	static char serial[13] = "FFFFFFFEFFFF";
