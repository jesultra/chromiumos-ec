...
class PinweaverModel {
 public:
  ...
  void ApplyRequest(const  fuzz::pinweaver::Request& pinweaver,
 ...
 private:
  ...
  size_t CopyMetadata(uint64_t label, const LeafData& leaf_data,
  ...
  void ApplyResetTree(const  fuzz::pinweaver::Request& pinweaver,
                      fuzz::span<uint8_t> buffer);
